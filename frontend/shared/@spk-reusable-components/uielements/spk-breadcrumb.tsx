...
const SpkBreadcrumb : React.FC<BreadcrumbProps> = ({ items, separator, SvgIcon , SvgClass, Svgstrokewidth, olclass}) => {
  return (
    <Fragment>
      <ol className={`flex items-center whitespace-nowrap min-w-0 flex-wrap ${olclass}`}>
