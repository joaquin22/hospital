...
const   SpkButton = ({ children, variant, disabled, customClass, buttontype,Btnstyle, Role,Themevalue,Currentpage,Steppercomplete,Decremenet, Copymarkup, Increment,Togglepassword, Size,Stepperskip, Stepperreset,StepperBack, Stepperfinish,onclickfunc,Steppernext, removeelement,Overlayoptions, Id, Expand, Label, Collapse, Controls, Overlay, Tab, Overlayclose}:any) => {
  return (
    <Fragment>
